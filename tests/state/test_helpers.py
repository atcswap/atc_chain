...
from atc_chain.state.active_state import ActiveState
from atc_chain.state.shard_and_committee import ShardAndCommittee
...
def test_get_proposer_position(monkeypatch,
                               ...
                               config):
    from atc_chain.state import helpers
