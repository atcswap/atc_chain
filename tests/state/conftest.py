...
from atc_chain.state.config import (
...
from atc_chain.state.attestation_record import (
    AttestationRecord,
)
from atc_chain.state.block import (
    Block,
)
from atc_chain.state.validator_record import (
    ValidatorRecord,
)
from atc_chain.state.state_transition import (
...
from atc_chain.state.helpers import (
    get_hashes_to_sign,
    get_proposer_position,
)

import atc_chain.utils.bls
...
def mock_bls(mocker, request):
    ...
    mocker.patch('atc_chain.utils.bls.verify', side_effect=bls_verify_mock)
    mocker.patch('atc_chain.utils.bls.sign', side_effect=bls_sign_mock)
